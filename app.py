...
app = Flask(__name__)
app.secret_key = "BLACK_ADMIN_STRICT_GLOW_999"
...
def start_app(user, app_name):
    ...
    # Path Finder: Bhetore folder thakleo main file khujbe
    found_main = None
...
# --- Baki shob route (index, run, stop, admin) ager motoi thakbe ---
...
def admin_login():
    ...
    return 'Admin Login Form...' # Render admin form here
